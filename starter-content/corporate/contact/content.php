	...
	<div class="container">
		<div class="row row-spacing-sm" style="padding-bottom: 100px;">
			<div class="col-md-6 col-sm-6 col-xs-12">
				...
				<p style="margin-top: 35px;">Targeting a holistic approach yet make users into advocates. Taking user stories to, consequently, target the low hanging fruit.</p>
				<div class="row current-edit-as-row">
					<div class="col-md-12 col-xs-12 col-sm-12">
						<div class="image-shadow bg-box bg-box-square bg-box-cover color-4-text-contrast color4-background-color" style="margin-top: 35px; padding: 2em 3em;">
							...
							<p style="margin-bottom: 5px;">1234 Franconia Way</p>
