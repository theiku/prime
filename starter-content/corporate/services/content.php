    ...
    <div class="container">
        <div class="row" style="padding-top: 80px; padding-bottom: 80px;">
            <div class="col-md-3 col-xs-12 col-sm-3 text-center" style="padding: 2em;">
                <p class=""><img src="<?php $image_path( 'icons/008-idea.png' ) ?>" alt="" width="75" height="75"></p>
            ...
            <div class="col-md-3 col-xs-12 col-sm-3 text-center" style="padding: 2em;">
                <p class=""><img src="<?php $image_path( 'icons/009-options.png' ) ?>" alt="" width="75" height="75"></p>
                <h3 class="" style="margin-top: 35px;">Create</h3>
                <p class="">Lead bleeding edge and then further your reach. Synchronizing below the line.</p>
            </div>
            <div class="col-md-3 col-xs-12 col-sm-3 text-center" style="padding: 2em;">
                <p class=""><img src="<?php $image_path( 'icons/010-start.png' ) ?>" alt="" width="62" height="75"></p>
