	...
	<div class="container">
		<div class="row" style="padding-top: 45px; padding-bottom: 35px;">
			...
			<div class="col-md-8 col-xs-12 col-sm-12 text-center">
				<p style="color: #fff; text-transform: uppercase; margin-bottom: 0px;">Take Your Steps</p>
	...
	<div class="container">
		<div class="row" style="padding-top: 80px; padding-bottom: 80px;">
			<div class="col-md-3 col-xs-12 col-sm-3 text-center" style="padding: 2em;">
				...
				<h3 style="margin-top: 35px;">Discover</h3>
				<p>Lead bleeding edge and then further your reach. Synchronizing below the line.</p>
			</div>
			<div class="col-md-3 col-xs-12 col-sm-3 text-center" style="padding: 2em;">
				<p><img src="<?php $image_path( 'icons/009-options.png' ) ?>" alt="" width="75" height="75"></p>
				<h3 style="margin-top: 35px;">Create</h3>
				<p>Lead bleeding edge and then further your reach. Synchronizing below the line.</p>
			</div>
			<div class="col-md-3 col-xs-12 col-sm-3 text-center" style="padding: 2em;">
				<p><img src="<?php $image_path( 'icons/010-start.png' ) ?>" alt="" width="62" height="75"></p>
				<h3 style="margin-top: 35px;">Energy</h3>
				<p>Lead bleeding edge and then further your reach. Synchronizing below the line.</p>
			</div>
			<div class="col-md-3 col-xs-12 col-sm-3 text-center" style="padding: 2em;">
...
<div class="boldgrid-section" style="color: #fff; background-image: linear-gradient(to left, rgba(33, 33, 33, 0.5), rgba(33, 33, 33, 0.5)), url('<?php $image_path( 'services/services8.png' ) ?>'); background-size: cover; background-position: 50% 50%;"
	...
	<div class="container">
		<div class="row" style="padding-top: 80px; padding-bottom: 80px;">
			<div class="col-md-5 col-sm-4 col-xs-12">
				<p style="margin-bottom: 5px; text-transform: uppercase;">Take a Look</p>
				<h2 style="color: #fff; margin-top: 0px;">Glimpse</h2>
				<?php $divider(); ?>
			</div>
			<div class="col-md-7 col-xs-12 col-sm-12">
				<p style="margin-top: 35px;">Executing audience segments and try to be transparent. Generating analytics with a goal to build ROI. Grow stakeholder management so that we surprise and delight.</p>
