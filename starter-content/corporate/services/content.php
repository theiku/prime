	...
	<div class="container">
		<div class="row row-spacing-lg-top row-spacing-sm-bottom">
			...
			<div class="col-md-6 col-sm-12 col-xs-12 align-column-center">
				<p style="margin: 2em 0" class="text-center" ><img class="bg-img bg-img-3" src="<?php $image_path('services/services1.png') ?>">
			</div>
		</div>
	</div>
</div>
...
<div class="boldgrid-section" style="color: #fff; background-image: linear-gradient(to left, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('<?php $image_path( 'services/services8.jpg' ) ?>'); background-size: cover; background-position: 50% 50%;"
	data-bg-overlaycolor="rgba(0,0,0,0.5)" data-image-url="<?php $image_path( 'services/services8.jpg' ) ?>">
	<div class="container">
