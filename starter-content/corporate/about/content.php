    ...
    <div class="container">
        <div class="row" style="padding-bottom: 100px; padding-top: 100px;">
            <div class="col-md-5 col-xs-12 col-sm-5">
                <p class=""><img class="image-shadow" src="<?php $image_path( 'about/about1.png' ) ?>"></p>
            </div>
...
<div class="boldgrid-section" style="background-image: linear-gradient(to left, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('<?php $image_path( 'about/about2.png' ) ?>'); background-size: cover; background-position: 50% 50%;" data-image-url="https://source.unsplash.com/9l_326FISzk/1920x1080" data-bg-overlaycolor="rgba(33,33,33,0.5)">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4 col-xs-12 col-sm-4 color4-background-color color-4-text-contrast" style="padding: 2em;">
                <p class=""><img class="alignleft" src="<?php $image_path( 'icons/005-value.png' ) ?>" width="61" height="48"></p>
            ...
            <div class="col-md-4 col-xs-12 col-sm-4 col-sm-4 color3-background-color color-3-text-contrast" style="padding: 2em;">
                <p class=""><img class="alignleft" src="<?php $image_path( 'icons/006-development.png' ) ?>" alt="" width="61" height="48"></p>
            ...
            <div class="col-md-4 col-xs-12 col-sm-4 col-sm-4 color4-background-color color-4-text-contrast" style="padding: 2em;">
                <p class=""><img class="alignleft" src="<?php $image_path( 'icons/007-analysis.png' ) ?>" alt="" width="61" height="61"></p>
...
<div class="boldgrid-section color4-background-color color-4-text-contrast bg-background-color">
    <div class="container">
        <div class="row" style="padding-bottom: 100px; padding-top: 100px;">
            <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <div class="row" style="margin-top: 35px;">
                    <div class="col-md-6 col-xs-12 col-sm-12">
                        <h4 class="h5"><i class="fa bg-inserted-icon fa-check-square-o color1-color" style="margin: 0px 15px 0px 0px; font-size: 20px;" aria-hidden="true"><span style="display: none;">&nbsp;</span></i>Transformation</h4>
                        <h4 class="h5" style="margin-top: 35px;"><i class="fa bg-inserted-icon fa-check-square-o color1-color" style="margin: 0px 15px 0px 0px; font-size: 20px;" aria-hidden="true"><span style="display: none;">&nbsp;</span></i>Operations &amp; Robotics</h4>
                    </div>
                    <div class="col-md-6 col-xs-12 col-sm-12">
                        <div>
                            <h4 class="h5"><i class="fa bg-inserted-icon fa-check-square-o color1-color" style="margin: 0px 15px 0px 0px; font-size: 20px;" aria-hidden="true"> </i>Information Technology</h4>
                            <h4 class="h5" style="margin-top: 35px;"><i class="fa bg-inserted-icon fa-check-square-o color1-color" style="margin: 0px 15px 0px 0px; font-size: 20px;" aria-hidden="true"> </i>Unlimited Possibilites</h4>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-1 col-sm-1 col-xs-12"></div>
            <div class="col-md-5 col-xs-12 col-sm-5">
                <p class=""><img src="<?php $image_path( 'about/about3.png' ) ?>" class="image-shadow"></p>
            </div>
        </div>
    </div>
</div>
<div class="boldgrid-slider boldgrid-slider-wrap" data-config='{"arrows":false,"autoplay":true,"autoplaySpeed":"8","dots":true,"infinite":true,"bgOptions":{"arrowsPos":"standard","arrowsOverlay":true,"arrowsBgColor":"1","arrowsIcon":"angle","arrowsSize":"30","dotsPos":"bottom","dotsOverlay":false,"dotsColor":"1","dotsSize":"50"},"colors":{"arrowsBG":{"type":"class","value":"1","text":""},"dotsColor":{"type":"class","value":"1","text":""}}}'>
      ...
      <div class="container">
          <div class="row" style="padding-top: 100px;">
              <div class="col-md-4 col-xs-12 col-sm-5">
                  <p class=""><img src="<?php $image_path( 'about/about4.png' ) ?>" class="image-shadow"></p>
              </div>
              <div class="col-md-8 col-sm-7 col-xs-12">
                  ...
                  <p class="h4" style="text-align: right; margin-top: 75px;">Starr Hudson</p>
  ...
  <div class="boldgrid-section">
      <div class="container">
          <div class="row" style="padding-top: 100px;">
              <div class="col-md-4 col-xs-12 col-sm-5">
                  <p class=""><img src="<?php $image_path( 'about/about4b.png' ) ?>" class="image-shadow"></p>
              </div>
              <div class="col-md-8 col-sm-7 col-xs-12">
                  ...
                  <p class="h4" style="text-align: right; margin-top: 75px;">Teresa Oliver</p>
  ...
  <div class="boldgrid-section">
      <div class="container">
          <div class="row" style="padding-top: 100px;">
              <div class="col-md-4 col-xs-12 col-sm-5">
                  <p class=""><img src="<?php $image_path( 'about/about4c.png' ) ?>" class="image-shadow"></p>
              </div>
              <div class="col-md-8 col-sm-7 col-xs-12">
                  ...
                  <p class="h4" style="text-align: right; margin-top: 75px;">Leslie Boone</p>
    ...
    <div class="container">
        <div class="row" style="padding-top: 100px; padding-bottom: 35px;">
            ...
            <div class="col-md-7 col-xs-12 col-sm-7">
                <p style="margin-top: 35px;">Target user stories so that we maximise share of voice. Grow cloud computing with the aim to take this offline. Lead integrated tech stacks and above all, target the low hanging fruit.</p>
            </div>
        </div>
        <div class="row" style="padding-bottom: 100px;">
