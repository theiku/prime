			...
			<div class="inner">
				<div class="column">
					...
					<?php if ( si_get_company_email() ) : ?>
						<div class="company_info"><?php printf( __( '%1$s', 'sprout-invoices' ), si_get_company_email() ); //phpcs:ignore WordPress.WP.I18n.NoEmptyStrings ?></div>
					<?php endif ?>
		...
		<section class="row" id="paybar">
			<div class="inner">
				...
				<?php if ( $time_left > 0 ) :  ?>
					...
					<?php else : ?>
						<a href="#decline" class="decline_estimate status_change" data-status-change="decline" data-id="<?php the_ID() ?>" data-nonce="<?php esc_attr_e( wp_create_nonce( SI_Controller::NONCE ) ); //phpcs:ignore WordPress.WP.I18n.NonSingularStringLiteralText ?>"><?php esc_html_e( 'Decline Estimate', 'sprout-invoices' ) ?></a>
					<?php endif ?>
					...
					<?php else : ?>
						<a href="#accept" class="button accept_estimate status_change" data-status-change="accept" data-id="<?php the_ID() ?>" data-nonce="<?php esc_attr_e( wp_create_nonce( SI_Controller::NONCE ) ); //phpcs:ignore WordPress.WP.I18n.NonSingularStringLiteralText ?>"><?php esc_html_e( 'Accept Estimate', 'sprout-invoices' ) ?></a>
					<?php endif ?>
