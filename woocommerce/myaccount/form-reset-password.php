...
<form method="post" class="woocommerce-ResetPassword lost_reset_password">
	...
	<p><?php echo esc_html( apply_filters( 'woocommerce_reset_password_message', esc_html__( 'Enter a new password below.', 'woocommerce') ) ); ?></p>
	...
	<?php
	global $woocommerce;
	version_compare( $woocommerce->version, '3.3.5', '>' ) ? wp_nonce_field( 'reset_password', 'woocommerce-reset-password-nonce' ) : wp_nonce_field( 'reset_password' );
	?>
