	...
	function boldgrid_prime_framework_config( $config ) {
		...
		$config['starter-content']['posts'] = array(
			...
			'about' => array(
				'post_type' => 'page',
				'post_title' => 'About',
				'post_content' => '<div class="boldgrid-section"><div class="container"> <div class="row" style="padding-top: 25px; padding-bottom: 75px;"> <div class="col-md-4 col-sm-5 col-xs-12"> <p class="wow rotateInDownLeft" style="margin-top: 22px;" data-wow-duration="1.5s" data-wow-delay="1s"><img class="aligncenter" src="' . get_parent_theme_file_uri('images/bold-fresh-about1.png') . '"></p></div><div class="col-md-8 col-xs-12 col-sm-7"><p class="color1-color" style="margin-top: 22px; font-family: Great\ Vibes; font-size: 40px; margin-bottom: 0px;" data-font-family="Great Vibes">More about</p> <h2 class="" style="margin-top: 0px;">OUR RESTAURANT</h2> <p class="">The staff here at our restaurant is highly trained and deeply dedicated to making sure you have a great dining experience. We all want to see you happy and smiling, and we want you to enjoy coming to eat with us. That’s why we focus on hiring the best, and making sure their training goes above and beyond what you would get at other restaurants. If there’s ever a problem with any of our staff members we want to know about it right away, so we can make adjustments and help that staff member keep customers happy.</p> <p class="">Some of our staff members have been with us for many years, and we’re proud of their many accomplishments and the way they treat customers as valued members of our family. Come see us for lunch or dinner, and experience the level of care and compassion a good restaurant staff can provide.</p></div></div></div></div><div class="boldgrid-section color3-background-color color-3-text-contrast bg-background-color"><div class="container"><div class="row" style="padding-top: 50px; padding-bottom: 75px;"> <div class="col-md-6 col-xs-12 col-sm-7"> <p class="color1-color" style="margin-top: 22px; font-family: Great\ Vibes; font-size: 40px; margin-bottom: 0px;" data-font-family="Great Vibes">View our</p> <h2 class="" style="margin-top: 0px;">FEATURED VIDEO</h2> <p class="" style="margin-bottom: 25px;">Vivamus id euismod massa. Suspendisse orci est, cursus quis efficitur quis, porttitor sit amet justo. Sed ac orci felis. Phasellus commodo arcu placerat purus vulputate fringilla. Vivamus rutrum eu tortor non ultrices. Proin posuere porta ligula, id fermentum nisl vestibulum id. Nunc id neque ac magna fringilla ultrices vel quis sem. Fusce a sem vel nunc sollicitudin consectetur. Suspendisse gravida tempor diam, eget imperdiet dui dictum a. Aliquam hendrerit aliquam vehicula. Integer feugiat arcu sapien, in facilisis lacus rutrum eu. Pellentesque eget fringilla odio, et vestibulum turpis. Proin sit amet venenatis nisi.</p> </div> <div class="col-md-6 col-xs-12 col-sm-5 text-center wow rotateInDownRight" data-wow-duration="1.5s" data-wow-delay="1s"> [embed height="439" width="780"]https://www.youtube.com/watch?v=uK3SVn2CT1I[/embed]</div></div></div></div><div class="boldgrid-section background-fixed" style="background-image: linear-gradient(to left, rgba(0, 0, 0, 0.8), rgba(0, 0, 0, 0.8)), url(' . get_parent_theme_file_uri('images/bold-fresh-background.png') . '); background-size: cover; background-position: 50% 50%;" data-image-url="' . get_parent_theme_file_uri('images/bold-fresh-background.png') . '" data-bg-overlaycolor="rgba(0,0,0,0.8)"><div class="container"> <div class="row" style="padding-top: 50px;"> <div class="col-md-12 col-xs-12 col-sm-12 text-center"> <p class="color1-color" style="margin-top: 22px; font-family: Great\ Vibes; font-size: 40px; margin-bottom: 0px;" data-font-family="Great Vibes">Press</p> <h2 class="" style="margin-top: 0px; color: #ffffff;">REVIEWS</h2> </div> </div> <div class="row" style="padding-bottom: 50px; padding-top: 25px;"> <div class="col-md-3 col-sm-6 col-xs-12 text-center"> <div class="bg-box bg-box-square" style="padding: 2em; margin-top: 15px; margin-right: 10px; margin-left: 10px;"> <p class="" style="color: #ffffff;"><em>The food is absolutely amazing! Be sure to ask about the freshest ingredients on the menu as they have specials for locally sourced ingredients.</em></p> <h4 class="color4-color" style="text-align: center; margin-top: 20px;">LJ Regency</h4> </div> </div> <div class="col-md-3 col-sm-6 col-xs-12 text-center"> <div class="bg-box bg-box-square" style="padding: 2em; margin-top: 15px; margin-right: 10px; margin-left: 10px;"> <p class="" style="color: #ffffff;"><em>The staff and management were amazing! Bold Fresh is our go to choice for any event we want to celebrate and have a memorable meal. </em></p> <h4 class="color4-color" style="text-align: center; margin-top: 20px;">AllFirst Capital</h4> </div> </div> <div class="col-md-3 col-sm-6 col-xs-12 text-center"> <div class="bg-box bg-box-square" style="padding: 2em; margin-top: 15px; margin-right: 10px; margin-left: 10px;"> <p class="" style="color: #ffffff;"><em>We held our annual company event at Bold Fresh, and we were blown away by the excellent staff and great menu. Thank you Bold Fresh! </em></p> <h4 class="color4-color" style="text-align: center; margin-top: 20px;">Daily Local</h4> </div> </div> <div class="col-md-3 col-sm-6 col-xs-12 text-center"> <div class="bg-box bg-box-square" style="padding: 2em; margin-top: 15px; margin-right: 10px; margin-left: 10px;"> <p class="" style="color: #ffffff;"><em>Bold Fresh puts the emphasis on fresh. Talk to the staff about the daily specials made with local ingredients, they’re sure to impress you! </em></p> <h4 class="color4-color" style="text-align: center; margin-top: 20px;">Source Pros</h4></div></div></div></div></div><div class="boldgrid-section"><div class="container"><div class="row" style="padding-top: 50px;"><div class="col-md-12 col-xs-12 col-sm-12 text-center"> <p class="color1-color" style="margin-top: 22px; font-family: Great\ Vibes; font-size: 40px; margin-bottom: 0px;" data-font-family="Great Vibes">Meet us</p> <h2 class="" style="margin-top: 0px;">STAFF</h2> </div> </div> <div class="row" style="padding-top: 20px; padding-bottom: 75px;"> <div class="col-md-4 col-sm-4 col-xs-12" style="padding-top: 2em;"> <p class="" style="margin-bottom: 0px;"><img class="aligncenter" src="' . get_parent_theme_file_uri('images/bold-fresh-about2.png') . '"></p> <div class="row"> <div class="col-md-12 col-sm-12 col-xs-12"> <div style="padding: 35px;" class="bg-background-color bg-box color-3-text-contrast color3-background-color"> <p class="" style="margin: 0;"><strong>Carl Casper</strong></p> <p class="">Chef</p> <p class="wow zoomIn" style="margin-top: 30px;" data-wow-duration="1.5s" data-wow-delay="0.5s">A James Beard Foundation Award winner, Casper is recognized for popularizing sourdough and artisan breads in the US.</p> </div> </div> </div> </div> <div class="col-md-4 col-sm-4 col-xs-12" style="padding-top: 2em;"> <p class="" style="margin-bottom: 0px;"><img class="aligncenter" src="' . get_parent_theme_file_uri('images/bold-fresh-about3.png') . '"></p> <div class="row"> <div class="col-md-12 col-sm-12 col-xs-12"> <div style="padding: 35px;" class="bg-background-color bg-box color-3-text-contrast color3-background-color"> <p class="" style="margin: 0;"><strong>Cleon Salmon</strong></p> <p class="">Owner</p> <p class="wow zoomIn" style="margin-top: 30px;" data-wow-duration="1.5s" data-wow-delay="0.5s">Salmon is a renowned restaurateur and television personality, with multiple Michelin Starred restaurants and award winning TV shows.</p> </div> </div> </div> </div> <div class="col-md-4 col-sm-4 col-xs-12" style="padding-top: 2em;"> <p class="" style="margin-bottom: 0px;"><img class="aligncenter" src="' . get_parent_theme_file_uri('images/bold-fresh-about4.png') . '"></p> <div class="row"> <div class="col-md-12 col-sm-12 col-xs-12"> <div style="padding: 2em;" class="bg-box color-3-text-contrast color3-background-color"> <p class="" style="margin: 0;"><strong>Carol Raddimus</strong></p> <p class="">Chef</p> <p class="wow zoomIn" style="margin-top: 30px;" data-wow-duration="1.5s" data-wow-delay="0.5s">A Brooklyn native, Raddimus moved to Tokyo to open a Ramen shop and was officially recognized as the Ramen King of Japan in 2015.</p></div></div></div></div></div></div></div>',
				'meta_input' => array(
					'boldgrid_in_page_containers' => array( true ),
				)
			),
